...
public class FileManager {
	...
	public static String getDateFromUri(final Context context, final Uri uri) {
		...
		if (DocumentsContract.isDocumentUri(context, uri)) {
			...
			if (isExternalStorageDocument(uri)) {
				...
				if ("primary".equalsIgnoreCase(type)) {
					return String.valueOf((new File(Environment.getExternalStorageDirectory() + "/" + split[1])).lastModified());
				}
			...
			// DownloadsProvider
				...
				return getDateModifiedColumn(context, contentUri, null, null);
			}
			// MediaProvider
				...
				return getDateModifiedColumn(context, contentUri, selection, selectionArgs);
			}
		}
		// MediaStore (and general)
		else if ("content".equalsIgnoreCase(uri.getScheme())) {
			return getDateModifiedColumn(context, uri, null, null);
		}
		// File
	...
	public static String getDateModifiedColumn(Context context, Uri uri, String selection,
											   String[] selectionArgs) {

		Cursor cursor = null;
		final String column = MediaStore.MediaColumns.DATE_MODIFIED;
